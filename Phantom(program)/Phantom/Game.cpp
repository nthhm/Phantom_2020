...
void Game_Clear(void);				// ゲームクリア関数
void Game_Over(void);				// ゲームオーバー関数
...
void Game_Clear(void) {
	...
	mImageHandle = LoadGraph("dat\\images\\Clear.jpg");    //画像のロード
...
void Game_Over(void) {
	...
	mImageHandle = LoadGraph("dat\\images\\out.jpg");    //画像のロード
